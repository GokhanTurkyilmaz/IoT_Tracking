...
REDIPS.drag = (function () {
  var u,
    ...
    p = !1,
    v = "cell",
    Da = { div: [], cname: "redips-only", other: "deny" },
    Ya = { action: "deny", cname: "redips-mark", exception: [] },
    n = {},
    Za = { keyDiv: !1, keyRow: !1, sendBack: !1, drop: !1 };
  M = function () {
    return !1;
  };
  u = function (a) {
    ...
    e =
      void 0 === a
        ? C.getElementsByTagName("table")
        : document.querySelectorAll(a);
    for (b = a = 0; a < e.length; a++)
      if (
        !(
          "redips_clone" === e[a].parentNode.id ||
          -1 < e[a].className.indexOf("redips-nolayout")
        )
      ) {
        c = e[a].parentNode;
        d = 0;
        do "TD" === c.nodeName && d++, (c = c.parentNode);
        while (c && c !== C);
        f[b] = e[a];
    ...
    for (e = da = 1; a < f.length; a++)
      if (0 === f[a].redips.nestedLevel) {
        ...
        for (b = 0; b < c.length; b++)
          -1 < c[b].className.indexOf("redips-nolayout") ||
            ((c[b].redips.nestedGroup = e),
            (c[b].redips.sort = 100 * da + c[b].redips.nestedLevel));
        e++;
        da++;
      }
  };
  Ea = function (a) {
    ...
    b.touches
      ? ((a = Z = b.touches[0].clientX), (d = aa = b.touches[0].clientY))
      : ((a = Z = b.clientX), (d = aa = b.clientY));
    Wa = a;
    Xa = d;
    la = !1;
    ...
    C !== k.redips.container && ((C = k.redips.container), u());
    -1 === k.className.indexOf("row")
      ? (REDIPS.drag.mode = v = "cell")
      : ((REDIPS.drag.mode = v = "row"), (REDIPS.drag.obj = k = ka(k)));
    y();
    ...
    "cell" === v
      ? REDIPS.drag.event.clicked(n.current)
      : REDIPS.drag.event.rowClicked(n.current);
  ...
  Ra = function (a) {
    ...
    for (a = 0; a < f.length; a++)
      f[a].redips.nestedGroup === b &&
        (f[a].redips.sort = 100 * da + f[a].redips.nestedLevel);
    f.sort(function (a, b) {
  ...
  ka = function (a, b) {
    ...
    ea &&
      t &&
      ((g = d.redips.div),
      (g.className = xa(g.className.replace("redips-clone", ""))));
    c = a.cloneNode(!0);
    ea && t && (g.className += " redips-clone");
    e = c.rows.length - 1;
    g = "animated" === b ? 0 === e : !0;
    for (f = e; 0 <= f; f--)
      if (f !== d.rowIndex) {
  ...
  Na = function (a, b, c) {
    ...
    q = function (a) {
      var b;
      void 0 !== a.redips && a.redips.emptyRow
        ? wa(a, "empty", REDIPS.drag.style.rowEmptyColor)
        : ((b = B("TABLE", a)), b.deleteRow(a.rowIndex));
    };
    void 0 === c ? (c = k) : (d = !0);
    ...
    !1 !== REDIPS.drag.event.rowDroppedBefore(Pa, g) &&
      (!d && -1 < n.target.className.indexOf(REDIPS.drag.trash.className)
        ? t
          ? REDIPS.drag.event.rowDeleted()
          : REDIPS.drag.trash.questionRow
          ? confirm(REDIPS.drag.trash.questionRow)
            ? (q(e), REDIPS.drag.event.rowDeleted())
        ...
        : (m < a.rows.length
            ? l === D
              ? g > m
                ? fa.insertBefore(b, h)
                : fa.insertBefore(b, h.nextSibling)
              : "after" === REDIPS.drag.rowDropMode
              ? fa.insertBefore(b, h.nextSibling)
              : fa.insertBefore(b, h)
            : (fa.appendChild(b), (h = a.rows[0])),
          h && h.redips && h.redips.emptyRow
            ...
            : "switch" !== REDIPS.drag.rowDropMode ||
              t ||
              (A.insertBefore(h, e),
              void 0 !== e.redips && delete e.redips.emptyRow),
          (!d && t) || q(e),
          delete b.redips.emptyRow,
          d || REDIPS.drag.event.rowDropped(b, Pa, g)),
      0 < b.getElementsByTagName("table").length && u());
  };
  Ua = function (a, b) {
    var c,
      d,
  ...
  ga = function (a) {
    ...
    if (!t || "cell" !== v || (null !== l && null !== h && null !== m))
      if (null === l || null === h || null === m) REDIPS.drag.event.notMoved();
        ...
        l < f.length
          ? ((b = f[l]),
            (REDIPS.drag.td.target = n.target = b.rows[h].cells[m]),
            ba(l, h, m, ca),
            (c = l),
            (d = h))
          : null === x || null === z || null === E
          ? ((b = f[D]),
            (REDIPS.drag.td.target = n.target = b.rows[L].cells[X]),
            ba(D, L, X, ca),
            (c = D),
            (d = L))
          : ((b = f[x]),
            (REDIPS.drag.td.target = n.target = b.rows[z].cells[E]),
            ba(x, z, E, ca),
            (c = x),
            (d = z));
        if ("row" === v)
          if (Aa)
            if (D === c && L === d) {
              ...
              t
                ...
                : REDIPS.drag.event.rowDroppedSource(n.target);
            } else Na(c, d);
          ...
          if (t && D === l && L === h && X === m)
            ...
            k.parentNode.removeChild(k),
              --W[p.id],
              REDIPS.drag.event.notCloned();
          else if (-1 < n.target.className.indexOf(REDIPS.drag.trash.className))
            k.parentNode.removeChild(k),
              REDIPS.drag.trash.question
                ? setTimeout(function () {
                    confirm(REDIPS.drag.trash.question)
                      ? Fa()
                      : (t || (f[D].rows[L].cells[X].appendChild(k), y()),
                        REDIPS.drag.event.undeleted());
                  }, 20)
                : Fa();
          else if ("switch" === REDIPS.drag.dropMode)
            if (((a = REDIPS.drag.event.droppedBefore(n.target)), !1 === a))
              ma(!1);
            else {
              k.parentNode.removeChild(k);
            ...
            "overwrite" === REDIPS.drag.dropMode
              ? ((a = REDIPS.drag.event.droppedBefore(n.target)),
                !1 !== a && ja(n.target))
              : (a = REDIPS.drag.event.droppedBefore(n.target)),
              ma(a);
  ...
  ma = function (a) {
    ...
    if (!1 !== a) {
      ...
      "shift" !== REDIPS.drag.dropMode ||
        (!Va(n.target) && "always" !== REDIPS.drag.shift.after) ||
        ta(n.source, n.target);
      "top" === REDIPS.drag.multipleDrop && n.target.hasChildNodes()
        ? n.target.insertBefore(k, n.target.firstChild)
        : n.target.appendChild(k);
      Y(k);
  ...
  Y = function (a, b) {
    !1 === b
      ...
      : ((a.onmousedown = Ea), (a.ontouchstart = Ea), (a.ondblclick = Qa));
  };
  Ga = function (a) {
    a.style.top = "";
    a.style.left = "";
  ...
  ha = function (a) {
    ...
    var b = REDIPS.drag.scroll.bound,
      ...
      g;
    a.touches
      ? ((d = Z = a.touches[0].clientX), (e = aa = a.touches[0].clientY))
      : ((d = Z = a.clientX), (e = aa = a.clientY));
    c = Math.abs(Wa - d);
    g = Math.abs(Xa - e);
    if (!Aa) {
      if ("cell" === v && (ea || (!0 === REDIPS.drag.clone.keyDiv && Oa)))
        (REDIPS.drag.objOld = p = k),
          (REDIPS.drag.obj = k = ra(k, !0)),
          (t = !0),
    ...
    "cell" === v &&
      (7 < c || 7 < g) &&
      !la &&
      ((la = !0), oa(), REDIPS.drag.event.moved(t));
    ...
    d < H[1] &&
      ...
      0 === U &&
      0 === V &&
      (q.containTable || d < q[3] || d > q[1] || e < q[0] || e > q[2]) &&
      (T(), na());
    if (REDIPS.drag.scroll.enable)
      for (
        P = b - (J / 2 > d ? d - r[3] : J - d - r[1]),
          0 < P
            ? (P > b && (P = b),
              (c = N()[0]),
              (P *= d < J / 2 ? -1 : 1),
              (0 > P && 0 >= c) ||
                (0 < P && c >= ya - J) ||
                0 !== U++ ||
                (REDIPS.event.remove(window, "scroll", y), pa(window)))
            : (P = 0),
          Q = b - (K / 2 > e ? e - r[0] : K - e - r[2]),
          0 < Q
            ? (Q > b && (Q = b),
              (c = N()[1]),
              (Q *= e < K / 2 ? -1 : 1),
              (0 > Q && 0 >= c) ||
                (0 < Q && c >= za - K) ||
                0 !== V++ ||
                (REDIPS.event.remove(window, "scroll", y), qa(window)))
            : (Q = 0),
          g = 0;
        g < O.length;
        g++
        ...
        if (
          ...
          R =
            b -
            (c.midstX > d ? d - r[3] - c.offset[3] : c.offset[1] - d - r[1]);
          0 < R
            ? (R > b && (R = b),
              (R *= d < c.midstX ? -1 : 1),
              0 === U++ && (REDIPS.event.remove(c.div, "scroll", y), pa(c.div)))
            : (R = 0);
          S =
            b -
            (c.midstY > e ? e - r[0] - c.offset[0] : c.offset[2] - e - r[2]);
          0 < S
            ? (S > b && (S = b),
              (S *= e < c.midstY ? -1 : 1),
              0 === V++ && (REDIPS.event.remove(c.div, "scroll", y), qa(c.div)))
            : (S = 0);
          break;
        } else R = S = 0;
    a.cancelBubble = !0;
  ...
  na = function () {
    l < f.length &&
      ...
      (null !== x &&
        ...
        null !== E &&
        (ba(x, z, E, ca),
        (REDIPS.drag.td.previous = n.previous = f[x].rows[z].cells[E]),
        (REDIPS.drag.td.current = n.current = f[l].rows[h].cells[m]),
        "switching" === REDIPS.drag.dropMode &&
          "cell" === v &&
          (ia(n.current, n.previous), y(), T()),
        "cell" === v
          ? REDIPS.drag.event.changed(n.current)
          : "row" !== v ||
            (l === x && h === z) ||
            REDIPS.drag.event.rowChanged(n.current)),
      oa());
  };
  Ha = function () {
  ...
  T = function () {
    ...
    for (l = 0; l < f.length; l++)
      if (
        !1 !== f[l].redips.enabled &&
        ((c[0] = f[l].redips.offset[0]),
        (c[1] = f[l].redips.offset[1]),
        (c[2] = f[l].redips.offset[2]),
        (c[3] = f[l].redips.offset[3]),
        void 0 !== f[l].sca &&
          ((c[0] = c[0] > f[l].sca.offset[0] ? c[0] : f[l].sca.offset[0]),
          (c[1] = c[1] < f[l].sca.offset[1] ? c[1] : f[l].sca.offset[1]),
          (c[2] = c[2] < f[l].sca.offset[2] ? c[2] : f[l].sca.offset[2]),
          (c[3] = c[3] > f[l].sca.offset[3] ? c[3] : f[l].sca.offset[3])),
        c[3] < b && b < c[1] && c[0] < g && g < c[2])
      ) {
        ...
        d = h;
        h === c.length - 1 &&
          ((q[0] = c[h][0]), (q[2] = f[l].redips.offset[2]));
        do
          for (
            m = e = f[l].rows[h].cells.length - 1;
            0 <= m &&
            !((q[3] = c[h][3] + f[l].rows[h].cells[m].offsetLeft),
            (q[1] = q[3] + f[l].rows[h].cells[m].offsetWidth),
            q[3] <= b && b <= q[1]);
            m--
          );
        while (f[l].redips.rowspan && -1 === m && 0 < h--);
        0 > h || 0 > m
          ? a()
          : h !== d &&
            ((q[0] = c[h][0]),
            (q[2] = q[0] + f[l].rows[h].cells[m].offsetHeight),
            (g < q[0] || g > q[2]) && a());
        ...
        if (-1 === b.className.indexOf(REDIPS.drag.trash.className))
          if (
            ((g = -1 < b.className.indexOf(REDIPS.drag.only.cname)), !0 === g)
          ) {
            if (-1 === b.className.indexOf(Da.div[k.id])) {
              a();
              break;
            }
          } else if (void 0 !== Da.div[k.id] && "deny" === Da.other) {
            a();
            break;
          } else if (
            ((g = -1 < b.className.indexOf(REDIPS.drag.mark.cname)),
            ((!0 === g && "deny" === REDIPS.drag.mark.action) ||
              (!1 === g && "allow" === REDIPS.drag.mark.action)) &&
              -1 === b.className.indexOf(Ya.exception[k.id]))
          ) {
            a();
            break;
          }
        ...
        if ("cell" === v) {
          if (
            ...
            for (d = b.childNodes.length - 1; 0 <= d; d--)
              if (
                b.childNodes[d].className &&
                -1 < b.childNodes[d].className.indexOf("redips-drag")
              ) {
                g = !1;
                break;
              }
  ...
  oa = function () {
    l < f.length &&
      ...
      null !== h &&
      null !== m &&
      ((ca = Ia(l, h, m)), ba(l, h, m), (x = l), (z = h), (E = m));
  };
  ba = function (a, b, c, d) {
    if ("cell" === v && la)
  ...
  y = function () {
    ...
    for (a = 0; a < f.length; a++) {
      c = [];
      d = I(f[a], "position");
      "fixed" !== d && (d = I(f[a].parentNode, "position"));
      for (b = f[a].rows.length - 1; 0 <= b; b--)
        "none" !== f[a].rows[b].style.display && (c[b] = G(f[a].rows[b], d));
      f[a].redips.offset = G(f[a], d);
      f[a].redips.row_offset = c;
    }
    H = G(C);
    for (a = 0; a < O.length; a++)
      (d = I(O[a].div, "position")),
        (b = G(O[a].div, d, !1)),
        (O[a].offset = b),
        (O[a].midstX = (b[1] + b[3]) / 2),
        (O[a].midstY = (b[0] + b[2]) / 2);
  };
  N = function () {
    var a, b;
    "number" === typeof window.pageYOffset
      ? ((a = window.pageXOffset), (b = window.pageYOffset))
  ...
  pa = function (a) {
    ...
    w === window
      ? ((a = N()[0]), (b = ya - J), (c = P))
      : ((a = w.scrollLeft), (b = w.scrollWidth - w.clientWidth), (c = R));
    0 < U && ((0 > c && 0 < a) || (0 < c && a < b))
      ? (w === window
          ? (window.scrollBy(c, 0),
            N(),
            ...
            isNaN(a))
          : (w.scrollLeft += c),
        setTimeout(pa, REDIPS.drag.scroll.speed))
      : (REDIPS.event.add(w, "scroll", y), (U = 0), (q = [0, 0, 0, 0]));
  };
  qa = function (a) {
    var b, c;
    b = Z;
    ...
    w === window
      ? ((a = N()[1]), (b = za - K), (c = Q))
      : ((a = w.scrollTop), (b = w.scrollHeight - w.clientHeight), (c = S));
    0 < V && ((0 > c && 0 < a) || (0 < c && a < b))
      ? (w === window
          ? (window.scrollBy(0, c),
            N(),
            ...
            isNaN(a))
          : (w.scrollTop += c),
        setTimeout(qa, REDIPS.drag.scroll.speed))
      : (REDIPS.event.add(w, "scroll", y), (V = 0), (q = [0, 0, 0, 0]));
  };
  ra = function (a, b) {
    var c = a.cloneNode(!0),
      d = c.className,
    ...
    !0 === b &&
      ...
      (e = G(a)),
      (g = G(c)),
      (c.style.top = e[0] - g[0] + "px"),
      (c.style.left = e[3] - g[3] + "px"));
  ...
  sa = function (a, b) {
    ...
    null !== c &&
      ((d = parseInt(c[1], 10)),
      (c = parseInt(c[2], 10)),
      0 === c && 1 === b && ((e += " redips-clone"), 2 === d && F(!0, a)),
      (c += b),
      (e = e.replace(/climit\d_\d+/g, "climit" + d + "_" + c)),
      0 >= c &&
        ((e = e.replace("redips-clone", "")),
        2 === d
          ? (F(!1, a), REDIPS.drag.event.clonedEnd2())
  ...
  Ka = function (a) {
    var b = !1;
    a.srcElement
      ? ((b = a.srcElement.nodeName), (a = a.srcElement.className))
      : ((b = a.target.nodeName), (a = a.target.className));
    switch (b) {
      case "A":
      case "INPUT":
      case "SELECT":
  ...
  F = function (a, b) {
    ...
    !0 === a || "init" === a
      ? ((A = REDIPS.drag.style.borderEnabled), (h = "move"), (l = !0))
      : ((A = REDIPS.drag.style.borderDisabled), (h = "auto"), (l = !1));
    void 0 === b
      ? (g = C.getElementsByTagName("div"))
      : "string" === typeof b
      ? (g = document.querySelectorAll(b))
      : "object" !== typeof b ||
        ("DIV" === b.nodeName && -1 !== b.className.indexOf("redips-drag"))
      ? (g[0] = b)
      : (g = b.getElementsByTagName("div"));
    for (d = c = 0; c < g.length; c++)
      if (n.test(g[c].className))
        "init" === a || void 0 === g[c].redips
          ? ((g[c].redips = {}), (g[c].redips.container = C))
          : !0 === a && "number" === typeof k
          ? ((g[c].style.opacity = ""), (g[c].style.filter = ""))
          : !1 === a &&
            "number" === typeof k &&
            ((g[c].style.opacity = k / 100),
            (g[c].style.filter = "alpha(opacity=" + k + ")")),
          Y(g[c], l),
          (g[c].style.borderStyle = A),
          (g[c].style.cursor = h),
          (g[c].redips.enabled = l);
        ...
        if (0 < g)
          for (
            ...
            1 === a.childNodes[c].nodeType &&
              ...
              (Ba[e]++, d(a.childNodes[c], b));
      } else
        for (d = c = 0; c < g; c++)
          1 === a.childNodes[d].nodeType && "DIV" === a.childNodes[d].nodeName
            ? ((e = a.childNodes[d]),
              REDIPS.drag.event.relocateBefore(e, b),
              b.appendChild(e),
              e.redips && !1 !== e.redips.enabled && Y(e),
              REDIPS.drag.event.relocateAfter(e))
            : d++;
  };
  ja = function (a, b) {
    var c,
  ...
  ta = function (a, b) {
    ...
    v = function (a) {
      "delete" === REDIPS.drag.shift.overflow
        ...
        : "object" === typeof REDIPS.drag.shift.overflow &&
          u(a, REDIPS.drag.shift.overflow);
      t = !1;
    ...
    if (a !== b) {
      ...
      switch (f) {
        case "vertical2":
          c =
            c === d && a.redips.cellIndex === b.redips.cellIndex
              ? e
              : [p, b.redips.cellIndex];
          break;
        case "horizontal2":
          c =
            c === d && a.parentNode.rowIndex === b.parentNode.rowIndex
              ? e
              : [b.redips.rowIndex, r];
          break;
        default:
      ...
      "vertical1" === f || "vertical2" === f
        ? ((f = 1e3 * c[1] + c[0] < 1e3 * g[1] + g[0] ? 1 : -1),
          (d = p),
          (p = 0),
          (r = 1))
        : ((f = 1e3 * c[0] + c[1] < 1e3 * g[0] + g[1] ? 1 : -1),
          (d = r),
          (p = 1),
          (r = 0));
      for (
        ...
        (h = k[c[0] + "-" + c[1]]),
          (c[p] += f),
          0 > c[p] ? ((c[p] = d), c[r]--) : c[p] > d && ((c[p] = 0), c[r]++),
          (e = k[c[0] + "-" + c[1]]),
          void 0 !== e && (l = e),
          void 0 !== h && (m = h),
          (void 0 !== e && void 0 !== m) || (void 0 !== l && void 0 !== h)
            ? ((e = -1 === l.className.indexOf(REDIPS.drag.mark.cname) ? 0 : 1),
              (h = -1 === m.className.indexOf(REDIPS.drag.mark.cname) ? 0 : 1),
              t && 0 === e && 1 === h && v(l),
              1 === e
                ? 0 === h && (q = m)
                : (0 === e && 1 === h && (m = q), u(l, m)))
  ...
  Ma = function (a, b) {
    ...
    (a < b.last && 0 < b.direction) || (a > b.last && 0 > b.direction)
      ...
      : (Ga(b.obj),
        ...
        "cell" === b.mode
          ? (!0 === b.overwrite && ja(b.targetCell),
            b.targetCell.appendChild(b.obj),
            b.obj.redips && !1 !== b.obj.redips.enabled && Y(b.obj))
          : Na(ua(b.target[0]), b.target[1], b.obj),
  ...
  wa = function (a, b, c) {
    var d, e;
    "string" === typeof a &&
      ((a = document.getElementById(a)), (a = B("TABLE", a)));
    if ("TR" === a.nodeName)
  ...
  return {
    ...
    init: function (a) {
      ...
      u();
      Ha();
      REDIPS.event.add(window, "resize", Ha);
      b = C.getElementsByTagName("img");
      for (a = 0; a < b.length; a++)
        REDIPS.event.add(b[a], "mousemove", M),
          REDIPS.event.add(b[a], "touchmove", M);
          ...
          for (e = a.rows[k].cells.length, l = 0; l < e; l++)
            if (((f = a.rows[k].cells[l]), 0 < f.childNodes.length))
              for (m = 0; m < f.childNodes.length; m++)
                (h = f.childNodes[m]),
                  "DIV" === h.nodeName &&
                    -1 < h.className.indexOf("redips-drag") &&
                    ((c += p + "[]=" + h.id + "_" + k + "_" + l + "&"),
                    n.push([h.id, k, l]));
        c =
          "json" === b && 0 < n.length
    ...
    moveObject: function (a) {
      ...
      if ("object" === typeof b.obj && null !== b.obj)
        return (
          ...
          b.obj.redips &&
            C !== b.obj.redips.container &&
            ((C = b.obj.redips.container), u()),
          (h = G(b.obj)),
          (e = h[1] - h[3]),
          (g = h[2] - h[0]),
          (c = h[3]),
          ...
          !0 === a.clone &&
            "cell" === b.mode &&
            ((b.obj = ra(b.obj, !0)), REDIPS.drag.event.cloned(b.obj)),
          void 0 === a.target
            ? (a.target = va())
            : "object" === typeof a.target &&
              "TD" === a.target.nodeName &&
              (a.target = va(a.target)),
          (b.target = a.target),
          (h = ua(a.target[0])),
          (k = a.target[1]),
          (a = a.target[2]),
          k > f[h].rows.length - 1 && (k = f[h].rows.length - 1),
          (b.targetCell = f[h].rows[k].cells[a]),
          "cell" === b.mode
            ? ((h = G(b.targetCell)),
              (k = h[1] - h[3]),
              (a = h[2] - h[0]),
...
REDIPS.event ||
  (REDIPS.event = (function () {
    return {
      add: function (u, F, M) {
        u.addEventListener
          ? u.addEventListener(F, M, !1)
          : u.attachEvent
          ? u.attachEvent("on" + F, M)
          : (u["on" + F] = M);
      },
      remove: function (u, F, M) {
        u.removeEventListener
          ? u.removeEventListener(F, M, !1)
          : u.detachEvent
          ? u.detachEvent("on" + F, M)
          : (u["on" + F] = null);
      },
    };
  })());
